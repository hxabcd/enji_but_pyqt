...
class Animation(QApplication):
    def __init__(self):
        ...
        self.font_id2 = QFontDatabase.addApplicationFont(
            "resources/AkazukiPOP_subset.otf"
        )
        ...
        self.starring = ContainerWindow(
            DecoratedLabel(
                pixmap=QPixmap("resources/starring.png"),
                decorations=[
                    Decoration(
        ...
        self.nerd_teto = ZoomImageWindow("resources/nerd_teto.jpg", (553, 500))

        self.gome_teto = ContainerWindow(
            DecoratedLabel(pixmap=QPixmap("resources/gome_teto.jpg")),
            position=("mid", "mid"),
            title="果咩纳塞",
        )

        self.minecraft_teto = ZoomImageWindow(
            "resources/minecraft_teto.jpg",
            (1415, 900),
            duration=1600,
            fade_duration=600,
            out_time=1000,
...
def main():
    ...
    # 傻逼 PyQt 不能在子线程预加载
    # 不管内存了 直接全局预载
    teto4: SequenceFrame = app.teto.preload_seqframe("frames/teto4", constract=False)  # type: ignore
    app.teto.preload_seqframe("frames/teto1")
    app.flag = 1
    ...
    def sequence_update(pos):
        ...
        if 0 <= pos < 700:
            ...
            app.small_teto2.preload_seqframe("frames/small_teto2")
            ...
            app.text_left.hide()
            app.teto.preload_seqframe("frames/teto2")
            ...
            app.teto.preload_seqframe("frames/teto3")
            ...
            app.text_left.hide()
            if app.teto.res_name != "frames/teto4":
                app.teto.load_widget(teto4, "frames/teto4")
                teto4.clear()
            ...
            app.kaomoji.hide()
            app.teto.preload_seqframe("frames/teto5")
            ...
            if app.flag:
                notify(
                    ...
                    icon=os.sep.join([os.getcwd(), r"resources\nerd_teto.jpg"]),
                )
                app.flag = 0
        elif 88200 <= pos < 90200:
            app.rotating_object.preload_seqframe("frames/img1")
            ...
            app.small_teto3.preload_seqframe("frames/small_teto3")
            ...
            app.text_left.hide()
            app.teto.preload_seqframe("frames/teto6")
            ...
            if app.flag:
                notify(
                    ...
                    image={
                        "src": os.sep.join([os.getcwd(), "resources/teto2.jpg"]),
                        "placement": "hero",
                    },
                    buttons=[
                        {
